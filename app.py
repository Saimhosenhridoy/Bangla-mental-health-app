...
.result-card { border-radius: 18px; padding: 1.5rem; color: white; background: #627C8C; box-shadow: 0 12px 40px rgba(98, 124, 140, 0.4); border: 3px solid #989398; min-height: 200px; display: flex; flex-direction: column; justify-content: center; }
...
.chart-container { background: #989398; border-radius: 18px; padding: 1.5rem; box-shadow: 0 6px 25px rgba(152, 147, 152, 0.3); border: 3px solid #627C8C; min-height: 200px; display: flex; flex-direction: column; justify-content: center; }
.example-container { background: #627C8C; border-radius: 14px; padding: 0.8rem; margin-bottom: 1rem; border: 3px solid #989398; }
.example-btn { border-radius: 10px; font-weight: 600; min-height: 38px; font-size: 0.85rem; background: #B9C7D2; border: 2px solid #2B3034; color: #000000; }
...
examples = [("Depressive", "কয়েকদিন ধরে আমার কোনো কাজে মন বসছে না।"), ("Non_depressive", "আজ সারাদিন কাজ করেছি, এখন বিশ্রাম নিচ্ছি।"), ("Positive", "আজ আমি খুব আনন্দিত, বন্ধুদের সঙ্গে সময় কাটিয়েছি।")]
